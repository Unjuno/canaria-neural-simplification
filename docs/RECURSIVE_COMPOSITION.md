...
Status: **C1–C20 completed; current recursive-composition line is at a release-review stopping point.**
...
| C20 | SmallViT central two-block, 16/32-dimensional self-anchor | CONFIRMATORY PASS | across 9 eligible fresh model seeds and four fresh identity/random basis choices, worst-basis anchored-16 improved frozen recursion; worst-basis/full-32 geometric NMSE ratio 1.0609× [1.0457, 1.0755], with validation/test utility safeguards passing |
