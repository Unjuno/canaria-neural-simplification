...
decision="VIT_MATCHED_BUDGET_CONFIRMATORY_PASS" if primary and safeguard else ("UNCERTAIN_COVERAGE" if not coverage else "VIT_MATCHED_BUDGET_CONFIRMATORY_FAIL")
