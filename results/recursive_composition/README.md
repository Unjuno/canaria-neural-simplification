...
C17 and C20 contain locked protocols, machine-derived seed rows, preregistered aggregate results, reports, and independent bootstrap audits.

## Exploration and negative evidence

The `exploration/` subtree preserves C1, C2, C4, C6, C8, C10, C11, C12, C14, C16, C18 and C19 records. Exploratory outcomes are calibration/mechanism evidence and must not be promoted to confirmatory claims.
...
- C19: the established central two-block SmallViT regime restores materially above-chance utility and motivates the fresh C20 confirmation.
