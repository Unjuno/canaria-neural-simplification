# Recursive-composition runners

This subtree contains the runners associated with the C-series composition experiments.

- `confirmatory/` — locked confirmatory runners for C3, C5, C7, C9, C13, C15, C17, C20 and C21.
...
Original per-experiment branches remain the protocol-before-outcome provenance source. This integrated subtree exists to make review and reuse practical without reintroducing archived legacy research surfaces.
