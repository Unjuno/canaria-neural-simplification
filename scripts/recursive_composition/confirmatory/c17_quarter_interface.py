...
def basis_family():
    ...
    return {
        "identity_first16": eye[:, :16],
        "random_20261010": random_orthogonal_basis(20261010)[:, :16],
        "random_20261011": random_orthogonal_basis(20261011)[:, :16],
        "random_20261012": random_orthogonal_basis(20261012)[:, :16],
    }
