...
def run(seed: int):
    ...
    anchored_acc = {k: v["anchored_8"]["final_replacement_val_acc"] for k, v in basis_records.items()}
    ...
    result.update({
        ...
        "aggregate": {
            ...
            "anchored_8_test_acc_by_basis": anchored_test_acc,
        },
