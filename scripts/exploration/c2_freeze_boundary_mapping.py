...
def run(seed):
    ...
    cluster_order = sorted(
        conditions,
        key=lambda k: conditions[k]["cluster"]["nmse_vs_original_teacher"],
    )
    recursive_order = sorted(
        conditions,
        key=lambda k: conditions[k]["recompiled_single"]["nmse_vs_original_teacher"],
    )
    ...
    return {
        ...
        "cluster_nmse_order_best_to_worst": cluster_order,
        "recursive_original_nmse_order_best_to_worst": recursive_order,
    }
